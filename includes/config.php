...
define('RASPI_WIFI_CLIENT_INTERFACE', 'wlan0_station');
...
define('RASPI_WPA_SUPPLICANT_CONFIG', '/etc/wpa_supplicant/wpa_supplicant-wlan0_station.conf');
...
define('RASPI_WIFI_COUNTRY_CODE','FR');
