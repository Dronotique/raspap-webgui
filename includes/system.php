...
function RPiVersion() {
  ...
  if (array_key_exists($rev, $revisions)) {
    return $revisions[$rev];
      ...
      return 'Unknown version ' . implode(",",$cpuinfo_array);
  }
}
...
?>
  ...
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation" class="serverinfotab"><a href="#serverinfo" aria-controls="serverinfo" role="tab" data-toggle="tab"><?php echo _("Server Info"); ?></a></li>
  </ul>
